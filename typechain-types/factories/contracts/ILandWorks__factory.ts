...
export class ILandWorks__factory {
  static readonly abi = _abi;
  static createInterface(): ILandWorksInterface {
    return new utils.Interface(_abi) as ILandWorksInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ILandWorks {
    return new Contract(address, _abi, signerOrProvider) as ILandWorks;
  }
}

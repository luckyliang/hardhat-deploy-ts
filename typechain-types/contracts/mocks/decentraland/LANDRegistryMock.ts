...
export interface LANDRegistryMockInterface extends utils.Interface {
  functions: {
...
export interface LANDRegistryMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LANDRegistryMockInterface;
  ...
  functions: {
    ...
    setLandBalanceToken(
      _newLandBalance: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

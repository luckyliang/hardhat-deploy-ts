...
export interface ERC721ConsumableInterface extends utils.Interface {
  functions: {
...
export interface ERC721Consumable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721ConsumableInterface;

...
export interface IMetaverseConsumableAdapterFacetInterface
...
export interface IMetaverseConsumableAdapterFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMetaverseConsumableAdapterFacetInterface;

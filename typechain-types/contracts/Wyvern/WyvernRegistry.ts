...
export interface WyvernRegistryInterface extends utils.Interface {
  functions: {
    ...
    "allowanceAddress()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "allowanceAddress",
    values?: undefined
  ): string;
  ...
  events: {
    ...
    "ProxyChanged(address,address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ProxyChanged"): EventFragment;
}
...
export interface ProxyChangedEventObject {
  from: string;
  old: string;
  newProxy: string;
}
export type ProxyChangedEvent = TypedEvent<
  [string, string, string],
  ProxyChangedEventObject
>;

export type ProxyChangedEventFilter = TypedEventFilter<ProxyChangedEvent>;
...
export interface WyvernRegistry extends BaseContract {
  ...
  functions: {
    ...
    allowanceAddress(overrides?: CallOverrides): Promise<[number]>;
  ...
  filters: {
    ...
    "ProxyChanged(address,address,address)"(
      from?: null,
      old?: null,
      newProxy?: null
    ): ProxyChangedEventFilter;
    ProxyChanged(
      from?: null,
      old?: null,
      newProxy?: null
  ...
  estimateGas: {
    ...
    allowanceAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    allowanceAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;

...
export interface LibraStaticInterface extends utils.Interface {
  functions: {
    ...
    "transferFromERC721Exact(bytes,address[7],uint8,uint256[6],bytes)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "transferFromERC721Exact",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>,
...
export interface LibraStatic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LibraStaticInterface;

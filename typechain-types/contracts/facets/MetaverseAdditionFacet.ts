...
export interface MetaverseAdditionFacetInterface extends utils.Interface {
  functions: {
...
export interface MetaverseAdditionFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MetaverseAdditionFacetInterface;

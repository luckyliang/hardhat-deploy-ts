    ...
    Employable
{
    ...
    // Token name
    string private _name = "Chinese Zodiac v1";
    ...
    function burn(uint256 tokenId) public {
        require(
            isApproveFor(_msgSender()) ||
                owner() == _msgSender() ||
                ownerOf(tokenId) == _msgSender(), "ERC721: burn caller is not owner nor member of contract"
        );
        _burn(tokenId);
    }
}

...
func (_Abi *AbiCaller) Retrieve(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Abi.contract.Call(opts, &out, "retrieve")
...
//
// Solidity: function retrieve() view returns(uint256)
func (_Abi *AbiSession) Retrieve() (*big.Int, error) {
	return _Abi.Contract.Retrieve(&_Abi.CallOpts)
}

// Retrieve is a free data retrieval call binding the contract method 0x2e64cec1.
//
// Solidity: function retrieve() view returns(uint256)
func (_Abi *AbiCallerSession) Retrieve() (*big.Int, error) {
	return _Abi.Contract.Retrieve(&_Abi.CallOpts)
}
...
func (_Abi *AbiTransactor) Store(opts *bind.TransactOpts, newValue *big.Int) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "store", newValue)
}

// Store is a paid mutator transaction binding the contract method 0x6057361d.
//
// Solidity: function store(uint256 newValue) returns()
func (_Abi *AbiSession) Store(newValue *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Store(&_Abi.TransactOpts, newValue)
}

// Store is a paid mutator transaction binding the contract method 0x6057361d.
//
// Solidity: function store(uint256 newValue) returns()
func (_Abi *AbiTransactorSession) Store(newValue *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Store(&_Abi.TransactOpts, newValue)
}

// AbiValueChangedIterator is returned from FilterValueChanged and is used to iterate over the raw logs and unpacked data for ValueChanged events raised by the Abi contract.
type AbiValueChangedIterator struct {
	Event *AbiValueChanged // Event containing the contract specifics and raw log
...
func (it *AbiValueChangedIterator) Next() bool {
...
func (it *AbiValueChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AbiValueChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AbiValueChanged represents a ValueChanged event raised by the Abi contract.
type AbiValueChanged struct {
	NewValue *big.Int
...
func (_Abi *AbiFilterer) FilterValueChanged(opts *bind.FilterOpts) (*AbiValueChangedIterator, error) {

	logs, sub, err := _Abi.contract.FilterLogs(opts, "ValueChanged")
	if err != nil {
		return nil, err
	}
	return &AbiValueChangedIterator{contract: _Abi.contract, event: "ValueChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ValueChanged(uint256 newValue)
func (_Abi *AbiFilterer) WatchValueChanged(opts *bind.WatchOpts, sink chan<- *AbiValueChanged) (event.Subscription, error) {

	logs, sub, err := _Abi.contract.WatchLogs(opts, "ValueChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(AbiValueChanged)
				if err := _Abi.contract.UnpackLog(event, "ValueChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ValueChanged(uint256 newValue)
func (_Abi *AbiFilterer) ParseValueChanged(log types.Log) (*AbiValueChanged, error) {
	event := new(AbiValueChanged)
	if err := _Abi.contract.UnpackLog(event, "ValueChanged", log); err != nil {
		return nil, err
	}
